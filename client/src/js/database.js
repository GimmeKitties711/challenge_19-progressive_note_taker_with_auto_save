...
export const putDb = async (content) => {
  ...
  //result ? console.log('🚀 data saved to database: ', result.value) : console.log('🚀 Data not found in the database.')
  console.log('Your latest changes have been saved to the database.');
}
